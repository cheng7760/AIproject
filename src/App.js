    ...
    <div className="App">
      ...
      <div className="quote-container">
        ...
        <div className="version-container">
          <p><span>站点版本：v2.0.0</span> <span><a href="https://raw.gitmirror.com/cheng7760/AIproject/main/public/logs/Cyrus-website.txt" className="version-link">查看更新日志</a></span></p>
      </div>
     </div>
      <div className="category editor-recommend">
        ...
        <div className="project" id="chatgpt-next-web">
          <h2><img src="https://raw.gitmirror.com/cheng7760/AIproject/main/public/icons/ChatGPT by Cyrus.png" alt="ChatGPT Next Web Icon" className="project-icon" /> ChatGPT by Cyrus</h2>
          ...
          <div className="button-group">
            ...
            <a href="https://raw.gitmirror.com/cheng7760/AIproject/main/public/faqs/ChatGPT by Cyrus.txt" className="button">查看教程</a>
          </div>
        ...
        <div className="project" id="bing">
            <h2><img src="https://raw.gitmirror.com/cheng7760/AIproject/main/public/icons/Bing AI.png" alt="Bing AI Icon" className="project-icon" /> Bing AI</h2>
            ...
            <div className="button-group">
              ...
              <a href="https://raw.gitmirror.com/cheng7760/AIproject/main/public/faqs/Bing AI.txt" className="button">查看教程</a>
            </div>
