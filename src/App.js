  ...
  return (
    <div className="App">
      ...
      <div className="project">
        <h2><img src="https://raw.githubusercontent.com/Cyrus-Reed/Cyrus-website/main/public/icons/ChatGPT-Next-Web.png" alt="ChatGPT Icon" className="project-icon" /> ChatGPT</h2>
      ...
      <div className="project">
        <h2><img src="https://raw.githubusercontent.com/Cyrus-Reed/Cyrus-website/main/public/icons/go-proxy-bing.png" alt="Bing AI Icon" className="project-icon" /> Bing AI</h2>
      ...
      <div className="project">
        <h2><img src="https://raw.githubusercontent.com/Cyrus-Reed/Cyrus-website/main/public/icons/chatgpt-vercel.png" alt="DALL·E Icon" className="project-icon" /> DALL·E</h2>
