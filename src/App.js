  ...
  return (
    <div className="App">
      ...
      <div className="project">
        ...
        <p>ChatGPT是一个由OpenAI开发和发布的人工智能聊天机器人，基于GPT-3.5语言模型。现已接入业界最先进的AI绘图技术Midjourney。用户用/mj为前缀输入绘画描述，例如：/mj a cat，即可生成绘画，速度较慢，生成中请勿重复提交或刷新页面，目前只支持英文描述。</p>
      ...
      <div className="project">
        ...
        <p>Bing AI是一个全新的人工智能搜索引擎，由微软开发和发布，基于GPT-4语言模型。现已接入OpenAI自研的AI绘图技术DALL·E2。用户需要选择更有创造力对话样式，输入绘画描述，例如：请帮我画一个小猪，即可生成绘画，速度较快，支持中文提示词。</p>
        <div className="button-group">
