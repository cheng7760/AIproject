      ...
      <div className="category">
        ...
        <div className="project">
          ...
          <div className="button-group">
            ...
            <a href="https://cloudflare-reverse-proxy.cyrus-reed.com/proxy/https://raw.githubusercontent.com/Cyrus-Reed/Cyrus-app/main/Android/ChatGPT_1.0.apk" className="button">下载应用</a>
