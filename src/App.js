  ...
  <p className="recommendation">推荐理由：功能丰富，无需登录点击即用，已支持选择 GPT-4 模型，适合新手使用。</p>
      ...
      <div className="category">
        ...
        <div className="project" id="bing">
          ...
          <p className="project-note">提醒：请您即时删除聊天历史，保护隐私安全</p>
          <div className="button-group">
            <a href="https://bing.cyrus-reed.com" className={`button ${isBingAIMaintenance ? 'disabled' : ''}`} 
   ...
   {isBingAIMaintenance ? '暂停维护' : '进入站点'} 
     ...
     <div className="project" id="yuexi">
          ...
          <p>本项目基于 OPENAI API 开发，内置了 KEY 让您只需微信添加 乐熙 后就可以开始聊天，她使用 GPT-4 模型，可以提供高质量的对话体验，支持私聊和群聊的智能回复。同时，她拥有上下文记忆、情绪模块以及人格模块。她出生于大宋繁华之地，自小热爱儒雅诗文，嗜好琵琶古筝。天性善良，崇尚“仁义礼智信”五常，对万事万物皆怀有深深的敬爱。</p>
          <div className="button-group">
